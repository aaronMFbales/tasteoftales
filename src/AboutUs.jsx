...
export default function AboutUs() {
  ...
  <div style={{ color: '#634832', fontSize: '1.25rem', maxWidth: '1200px', width: '100%', margin: '0 auto', textAlign: 'center', lineHeight: '2', fontFamily: 'system-ui, Avenir, Helvetica, Arial, sans-serif', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
    ...
    <div style={{ marginBottom: '2.5rem' }}>
        ...
        <div style={{ marginBottom: '2.5rem' }}>
            <img src="/expo opening.jpg" alt="Expo Opening" className="about-img-lift" style={{ width: '70%', maxWidth: '500px', borderRadius: '1.5rem', marginBottom: '2rem', boxShadow: '0 4px 24px #a0521c44' }} onClick={e => handleImgClick('/expo opening.jpg', 'Expo Opening')} />
