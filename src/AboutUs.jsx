    ...
    <div style={{ marginBottom: '2.5rem' }}>
        ...
        <div style={{ marginBottom: '2.5rem' }}>
          ...
          <div style={{ fontStyle: 'italic' }}>
            ...
            <img src="/pc 1.jpg" alt="Personal Chapter 1" style={{ width: '70%', maxWidth: '400px', display: 'block', margin: '2rem auto', borderRadius: '1.5rem', boxShadow: '0 4px 24px #a0521c44' }} />
            ...
            <img src="/pc 2.jpg" alt="Personal Chapter 2" style={{ width: '70%', maxWidth: '400px', aspectRatio: '16/9', height: 'auto', objectFit: 'cover', display: 'block', margin: '2rem auto', borderRadius: '1.5rem', boxShadow: '0 4px 24px #a0521c44' }} />
      ...
      <div style={{ fontSize: '2.5rem', fontWeight: 700, color: '#7e5f3b', marginBottom: '1.2rem', fontStyle: 'italic', fontFamily: 'system-ui, Avenir, Helvetica, Arial, sans-serif' }}><b>Coffee in Spirit — Sir Jan’s Story</b></div>
          <div style={{ fontStyle: 'italic' }}>That same day, we witnessed Sir Jan step onto the stage for the Coffee in Spirit competition. He carried with him not just ingredients but months of effort, trial, and inspiration. She told me of the struggles they went through, how they searched for balance, experimenting with flavors until realization struck: taste is never fixed, it is shaped by perception.<br /><br />
            ...
            <div style={{ display: 'flex', justifyContent: 'center', gap: '2.5rem', margin: '2rem 0' }}>
              <img src="/ing 1.jpg" alt="Ingredient 1" style={{ width: '32%', maxWidth: '220px', borderRadius: '1rem', boxShadow: '0 2px 12px #a0521c44', objectFit: 'cover' }} />
              <img src="/ing 2.jpg" alt="Ingredient 2" style={{ width: '32%', maxWidth: '220px', borderRadius: '1rem', boxShadow: '0 2px 12px #a0521c44', objectFit: 'cover' }} />
              <img src="/ing 3.jpg" alt="Ingredient 3" style={{ width: '32%', maxWidth: '220px', borderRadius: '1rem', boxShadow: '0 2px 12px #a0521c44', objectFit: 'cover' }} />
            </div>
        ...
        <div style={{ marginBottom: '2.5rem' }}>
          ...
          <img src="/sir jan awarding.jpg" alt="Sir Jan Awarding" style={{ width: '90%', maxWidth: '700px', display: 'block', margin: '2rem auto 2.5rem auto', borderRadius: '1.5rem', boxShadow: '0 4px 24px #a0521c44' }} />
